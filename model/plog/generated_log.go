...
func (ms LogRecord) Body() pcommon.AttributeValue {
	return pcommon.AttributeValue{pdata.NewAttributeValue(&(*ms.orig).Body)}
}
...
func (ms LogRecord) CopyTo(dest LogRecord) {
	...
	ms.Body().CopyTo(dest.Body().AttributeValue)
