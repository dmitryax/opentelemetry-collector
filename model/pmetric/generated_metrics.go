...
func (ms ResourceMetrics) Resource() pcommon.Resource {
	return pcommon.Resource{pdata.NewResource(&(*ms.orig).Resource)}
}
...
func (ms InstrumentationLibraryMetrics) InstrumentationLibrary() pcommon.InstrumentationLibrary {
	return pcommon.InstrumentationLibrary{pdata.NewInstrumentationLibrary(&(*ms.orig).InstrumentationLibrary)}
}
...
func (ms NumberDataPoint) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMap{pdata.NewAttributeMap(&(*ms.orig).Attributes)}
}
...
func (ms HistogramDataPoint) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMap{pdata.NewAttributeMap(&(*ms.orig).Attributes)}
}
...
func (ms ExponentialHistogramDataPoint) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMap{pdata.NewAttributeMap(&(*ms.orig).Attributes)}
}
...
func (ms SummaryDataPoint) Attributes() pcommon.AttributeMap {
	return pcommon.AttributeMap{pdata.NewAttributeMap(&(*ms.orig).Attributes)}
}
...
func (ms Exemplar) FilteredAttributes() pcommon.AttributeMap {
	return pcommon.AttributeMap{pdata.NewAttributeMap(&(*ms.orig).FilteredAttributes)}
}

// TraceID returns the traceid associated with this Exemplar.
func (ms Exemplar) TraceID() ptrace.TraceID {
	return ptrace.TraceID{pdata.NewTraceID(ms.orig.TraceId)}
}

// SetTraceID replaces the traceid associated with this Exemplar.
func (ms Exemplar) SetTraceID(v ptrace.TraceID) {
	v.TraceID.CopyToExemplar(ms.orig)
}

// SpanID returns the spanid associated with this Exemplar.
func (ms Exemplar) SpanID() ptrace.SpanID {
	return ptrace.SpanID{pdata.NewSpanID(ms.orig.SpanId)}
}

// SetSpanID replaces the spanid associated with this Exemplar.
func (ms Exemplar) SetSpanID(v ptrace.SpanID) {
	v.SpanID.CopyToExemplar(ms.orig)
}
