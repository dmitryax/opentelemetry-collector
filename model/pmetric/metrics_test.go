...
func TestOtlpToInternalReadOnly(t *testing.T) {
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(map[string]pcommon.AttributeValue{
		"string": pcommon.NewAttributeValueString("string-resource"),
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key0": pcommon.NewAttributeValueString(
			"value0")}), gaugeDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key1": pcommon.NewAttributeValueString(
			"value1")}), gaugeDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key0": pcommon.NewAttributeValueString(
			"value0")}), sumDataPoints.At(0).Attributes())
	// Second point
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key1": pcommon.NewAttributeValueString(
			"value1")}), sumDataPoints.At(1).Attributes())
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key0": pcommon.NewAttributeValueString(
			"value0")}), histogramDataPoints.At(0).Attributes())
	...
	assert.EqualValues(t, pcommon.NewAttributeMapFromMap(
		map[string]pcommon.AttributeValue{"key1": pcommon.NewAttributeValueString(
			"value1")}), histogramDataPoints.At(1).Attributes())
...
func TestOtlpToFromInternalGaugeMutating(t *testing.T) {
	newAttributes := pcommon.NewAttributeMapFromMap(map[string]pcommon.
		AttributeValue{"k": pcommon.NewAttributeValueString(
		"v")})
